...
function selectHand(svgObject,hand){
    ...
    var boxPos=document.getElementById("innersvg").getBoundingClientRect();
    // console.log(svgObject);
    
    // console.log(handPos.top, handPos.height/2);
    // console.log(boxPos.height/2);
    svgObject.style.transform=`translate(${boxPos.width/2-handPos.left-handPos.width/2}px,
